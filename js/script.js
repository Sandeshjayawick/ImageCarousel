...
(function() {
    ...
    app.carousel = {
        ...
        move: function(el) {
            ...
            dots[parseInt(selected.dataset.pos)].classList.add('active');
        },
        nextAll: function(el) {
            let els = [];
        ...
        init: function() {
            ...
            app.carousel.reorder();
            initDots(); // Initialize dots here
            app.selected = $(".selected");

            // Set up automatic image transition every 3 seconds
            setInterval(() => {
                app.carousel.move('next'); // Move to the next image
